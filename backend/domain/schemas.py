...
class IssueCluster(BaseModel):
    ...
    # Decision Score Pillars — transparent 4-component breakdown
    # Generated by DecisionIntelligenceEngine, never by AI
    decision_pillars: Optional[dict] = Field(default=None, description="Per-pillar score breakdown for UI transparency")
