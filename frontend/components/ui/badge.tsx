...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold tracking-wide border transition-all duration-200 animate-badge-priority",
  {
    variants: {
      variant: {
        default: "bg-slate-500/10 text-slate-400 border-slate-500/20",
        primary: "bg-primary/15 text-primary-soft border-primary/28",
        success: "bg-emerald-500/15 text-emerald-400 border-emerald-500/25",
        warning: "bg-amber-500/15 text-amber-400 border-amber-500/25",
        danger:
          "bg-red-500/15 text-red-400 border-red-500/25 animate-badge-pulse",
        outline: "border-white/15 text-slate-300 bg-transparent",
        bug: "bg-red-500/15 text-red-400 border-red-500/25 animate-badge-pulse",
        perf: "bg-orange-500/15 text-orange-400 border-orange-500/25",
        ux: "bg-primary/15 text-primary-soft border-primary/25",
        feature: "bg-sky-500/15 text-sky-400 border-sky-500/25",
        ...
        high: "bg-red-500/20 text-red-300 border-red-500/30 animate-badge-pulse",
